...
async function deployAndInitializeLiquidity() {
    try {
        ...
        const liquidityBacking = {
            ...
            lockedSupplyTokens: "70000000000000000000000000",
            tokenFloorPriceUSD: (10000 / 70000000).toFixed(8),
            lockDuration: "PERPETUAL_RENOUNCED",
            active: true
        };

        // 4. PRE-APPROVE THE INITIAL 10,000 TOKENS INSTANT SWAP
        const privilegedSwapRoute = {
            ...
            exchangePayout: (10000 / 3000).toFixed(6),
        ...
        pipe.set(`balance:${contractAddress}:${initialReceiver}`, "30000000000000000000000000");
        pipe.set(`balance:${contractAddress}:${contractAddress}`, "70000000000000000000000000");
